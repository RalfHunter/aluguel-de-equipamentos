export default  {
  ...
  "coveragePathIgnorePatterns": [
    ...
    // testMatch:['**/UsuarioController.test.js', '**/UsuarioService.test.js','**/usuarioRoutes.test.js']
    ...
    // testMatch:['**/EquipamentoController.test.js','**/EquipamentoQuerySchema.test.js', '**/EquipamentoSchema.test.js', '**/Equipamento.test.js', '**/EquipamentoService.test.js', '**/EquipamentoRepository.test.js', '**/EquipamentoFilterBuilder.test.js', '**/equipamentoRoutes.test.js']
    // testMatch:['**/equipamentoRoutes.test.js']
    //testMatch:['**/equipamentoRoutes.test.js']
